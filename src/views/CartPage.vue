<template>
  <div>
    <HeaderPart />
    <div class="cart">
      <div class="empty-cart" v-if="!inCart.length">
      ...
      <div v-else class="wrapper">
        <div v-for="(product, index) in inCart" :key="index" class="cart-item">
          <div class="item-wrapper">
            ...
            <div class="item-info">
              ...
              <ul v-show="product.showIngredients" class="ulIngredientList">
                <label
                  v-for="(ingredient, idx) in product.ingredients"
                  :key="idx"
                >
                  <li>
                    <input
                      type="checkbox"
                      checked
                      @click="ingredientClick($event, product)"
        ...
        <button class="make-order" @click="createOrder">Оформить заказ</button>
      </div>
    </div>
    <FooterPart />
